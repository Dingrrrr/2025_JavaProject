...
public class VoteMainScreen2 extends JFrame {
	...
	private void addVote() {
     ...
     // 이미지 URL에서 이미지 불러오기
        try {
            // URL에서 이미지를 불러와서 아이콘으로 설정
            ImageIcon imageIcon = new ImageIcon(new URL("http://113.198.238.98/dbimages/dog.png"));
            
            // 이미지를 176x150 크기로 조정
            Image image = imageIcon.getImage().getScaledInstance(176, 150, Image.SCALE_SMOOTH);
